<?php
/**
 * Single Post Template - Forge CMS
 */
...
<div class="content-wrapper">
    ...
    <article>
        <header style="margin-bottom: 2rem;">
            <h1 style="font-size: 2.5rem; font-weight: 800; line-height: 1.2; margin-bottom: 1rem;"><?= esc($post['title']) ?></h1>
            <div style="display: flex; align-items: center; gap: 1.5rem; color: var(--text-secondary); font-size: 0.9375rem;">
                <span style="display: flex; align-items: center; gap: 0.5rem;">
                    ...
                    <?= formatDate($post['published_at'], getOption('date_format', 'M j, Y')) ?>
                </span>
                <?php if ($author): ?>
                <span style="display: flex; align-items: center; gap: 0.5rem;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">

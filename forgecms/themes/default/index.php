...
<body>
    ...
    <section class="hero">
        <div class="container hero-content">
            ...
            <h1>Build anything with <span class="gradient">Forge CMS</span></h1>
            ...
            <div class="browser-body">
                ...
                <div class="browser-main">
                    ...
                    <div class="browser-table">
                        ...
                        <?php else: ?>
                            <div class="browser-table-row">
                                <div class="table-title">Getting Started with Forge</div>
                                <div>Admin</div>
                                <div><?= date('M j') ?></div>
    ...
    <section class="features" id="features">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-desc">Forge CMS combines powerful features with an intuitive interface. No bloat, no complexity — just the tools you need.</p>
            </div>
    ...
    <section class="cta">
        <div class="container">
            <div class="cta-box">
                ...
                <p class="cta-note">Forge CMS v<?= CMS_VERSION ?> • 100% Free & Open Source</p>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p class="footer-copy">© <?= date('Y') ?> <?= esc($siteTitle) ?>. Powered by Forge CMS v<?= CMS_VERSION ?>.</p>

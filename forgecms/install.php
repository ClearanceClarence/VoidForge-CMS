        ...
        if (empty($dbName) || empty($dbUser)) {
            ...
            try {
                ...
                $options = array(
                    ...
                    'site_tagline' => 'Another Forge CMS Site',
                    'site_url' => $siteUrl,
                ...
                $stmt->execute(array('Welcome to Forge CMS', 'welcome-to-forge-cms', '<p>Congratulations! You have successfully installed Forge CMS. This is your first post. Edit or delete it to get started.</p>'));
                ...
                $configLines = array();
                $configLines[] = '<' . '?php';
                $configLines[] = '// Forge CMS Configuration - Generated ' . date('Y-m-d H:i:s');
                $configLines[] = '';
...
<?php endif; ?>
            <form method="post">
                ...
                <button type="submit" name="install" class="btn btn-primary btn-block">Install Forge CMS <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></button>
            </form>
<?php elseif ($step === 3): ?>
            <div class="success-content">
                ...
                <p class="success-message">Forge CMS is ready. Start creating content!</p>
